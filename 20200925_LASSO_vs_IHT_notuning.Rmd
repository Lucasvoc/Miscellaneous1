...
for (i in c(1:length(SNR))) {
  X_test <- generate_X(100, 10, Sigma = Sigma)
  Y_test <- X_test%*%beta0+as.matrix(rnorm(100,0,sigma2[i]))
  intLASSORR <- rep(0,10)
  ...
  for (j in c(1:10)) {
    ...
    ## solve BSS
    estimate <- myiht2(X = X_train, Y = Y_train, proj_size = 5, expan_size = 10, beta0=rep(0,10))$dir_estimate
    sol_BSS = rep(0,10)
...
## begin the test
for (i in c(1:length(SNR))) {
  X_test <- generate_X(500, 100, Sigma = Sigma)
  ...
  for (j in c(1:10)) {
    ...
    ## solve BSS
    estimate <- myiht2(X = X_train, Y = Y_train, proj_size = 5, expan_size = 10, beta0=rep(0,100))$dir_estimate
    sol_BSS = rep(0,100)
    Xs <- X_train[, estimate[,1]]
    sol_BSS[estimate[,1]] = solve(t(Xs)%*%Xs)%*%t(Xs)%*%Y_train
...
## begin the test
for (i in c(1:length(SNR))) {
  X_test <- generate_X(50, 1000, Sigma = Sigma)
  Y_test <- X_test%*%beta0+as.matrix(rnorm(50,0,sigma2[i]))
  intLASSORR <- rep(0,10)
  intLASSOFDR <- rep(0,10)
  intLASSOTPR <- rep(0,10)
  intBSSRR <- rep(0,10)
  ...
  for (j in c(1:10)) {
    ...
    ## solve BSS
    estimate <- myiht2(X = X_train, Y = Y_train, proj_size = 5, expan_size = 10, beta0=rep(0,1000))$dir_estimate
    sol_BSS = rep(0,1000)
    Xs <- X_train[, estimate[,1]]
    sol_BSS[estimate[,1]] = solve(t(Xs)%*%Xs)%*%t(Xs)%*%Y_train
...
## begin the test
for (i in c(1:length(SNR))) {
  X_test <- generate_X(100, 1000, Sigma = Sigma)
  Y_test <- X_test%*%beta0+as.matrix(rnorm(100,0,sigma2[i]))
  intLASSORR <- rep(0,10)
  intLASSOFDR <- rep(0,10)
  intLASSOTPR <- rep(0,10)
  ...
  for (j in c(1:10)) {
   ...
   ## solve BSS
    estimate <- myiht2(X = X_train, Y = Y_train, proj_size = 10, expan_size = 10, beta0=rep(0,1000))$dir_estimate
    sol_BSS = rep(0,1000)
    Xs <- X_train[, estimate[,1]]
    sol_BSS[estimate[,1]] = solve(t(Xs)%*%Xs)%*%t(Xs)%*%Y_train
